const locale = {
  ...
  "label.center_wise_company_detail": "Centre wise Company detail",
  "label.search_by_company_name": "Search by Company Name",
  ...
  "label.interview_type": "Interview Type",
  "label.mode": "Mode",
  "label.center_name": "Center Name",
  "label.interview_dates": "Interview Dates",
  "label.shortlisting_round": "Shortlisting Round",
  "label.written_test": "Written Test",
  "label.provide_online_consent": "Provide Online Consent for Google, Round 1",
  "label.confirmation_provide_online_consent":
    "As you are providing your online consent, Please ensure that you would certainly appear for the interview",
  "label.grant_consent": "Grant Consent",
  "label.ahemdabad": "AHEMDABAD-I",
  "label.akola": "AKOLA",
