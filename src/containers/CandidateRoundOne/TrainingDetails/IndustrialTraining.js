...
const IndustrialTraining = (
  ...
  //states
  const [industrialTrainings, setIndustrialTrainings] = useState([
    industrialKeys,
  ]);
  ...
  const onDeleteIndustrialExperience = (LIndex) => {
    if (industrialTrainings.length > 1) {
      let newIndustrialExp = industrialTrainings.filter(
          ...
          <CardComponent customStyle={styles.cardContainer} key={`${index}`}>
            {industrialTrainings.length > 1 && (
              <CustomButton
                ...
                onPress={() => {
                  onDeleteIndustrialExperience(index);
                }}
              />
            )}
            <View style={isWebView ? styles.gridView : styles.gap}>
              ...
              <CustomTextInput
                ...
                label={intl.formatMessage({
                  id: "label.natureOfWorkdoneIndustrial",
                })}
                placeholder={intl.formatMessage({
                  id: "label.natureOfWorkdoneIndustrial",
                })}
              ...
              <CustomTextInput
                ...
                isPaddingNotRequired
                label={intl.formatMessage({
                  id: "label.natureOfWorkdoneIndustrialArticles",
                })}
                placeholder={intl.formatMessage({
                  id: "label.natureOfWorkdoneIndustrialArticles",
                })}
                ...
                onChangeText={(txt) =>
                  onDataChange(txt, index, "natureOfWorkInArticle")
                }
              />
            </View>
          </CardComponent>
