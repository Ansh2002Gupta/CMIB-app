...
const TrainingDetails = (
  ...
  const [isMembershipDetailsAdded, setIsMembershipDetailsAdded] =
    useState(false);
  const [isCaTrainingDetailsAdded, setIsCaTrainingDetailsAdded] =
    useState(false);
  ...
  const edDetailsConfig = [
    {
      content: (
        <GMCSDetailsTemplate
          ...
          ref={GMCSDetailsTemplateRef}
          intl={intl}
          isWebView={isWebView}
          isViewMode={isViewMode}
          onValidationChange={handleGMCSDeatils}
        />
      ),
    },
    {
      content: (
        <MembershipDetailsTemplate
          trainingDetails={trainingDetails}
          ref={MembershipDetailsTemplateRef}
          intl={intl}
          isWebView={isWebView}
          isViewMode={isViewMode}
          onValidationChange={handleMembershipDetails}
        />
      ),
    },
    {
      content: (
        <CaTrainingDetailsTemplate
          trainingDetails={trainingDetails}
          ref={CaTrainingDetailsTemplateRef}
          intl={intl}
          isWebView={isWebView}
          isViewMode={isViewMode}
          onValidationChange={handleCaTrainingDeatils}
        />
      ),
    },
  ];
